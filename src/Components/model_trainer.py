...
'''Simplifies the creation of classes that are used to store data by automatically generating initialization methods and other 
#useful functions'''
@dataclass 
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # This Function evaluate_model is defined into the utils function common function to find performance Returns Dict
            ...
            # Raise an exception if no good model is found
